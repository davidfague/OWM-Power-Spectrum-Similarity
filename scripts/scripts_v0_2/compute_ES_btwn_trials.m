...
%% constants
hellbender = false;
within_item = false; % computes control as either within item or between items
...
function [all_channels_save_file] = compute_all_between_trial_similarities(PS_file, target_enc_ids, target_image_ids, within_item)
    ...
    for chan_idx = 1:length(unique_channel_IDs)
        ...
        save(save_file, "chan_id", "control_EMS_matrices", "control_EMS_matrices_std", "-v7.3");
