...
% enc_win_IDs based on the encID where the thing is found.
    ...
    if params.within_item
        ...
        save_folder = fullfile(strrep(PS_file.Properties.Source, '.mat', sprintf('/corrWOitemMaint vs corrWitemEnc/between_trials_enc%d_image%d', target_enc_ids, target_image_ids)));
    end
