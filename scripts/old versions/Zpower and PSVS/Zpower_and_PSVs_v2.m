...
for idx = 1:length(patient_IDs)
    ...
    save_file = get_PS_file(output_folder, patient_ID, false);
    write_current_script_to_destination(fullfile(output_folder, num2str(patient_id), 'Zpower and PSVs'))
